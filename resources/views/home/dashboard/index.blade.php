...
@section('content')
    ...
    <main class="flex-1 relative overflow-y-auto overflow-x-hidden bg-slate-50 pb-24 md:pb-6">
            ...
            <div class="relative z-10 flex justify-between items-center mb-8">
                ...
                <div class="flex items-center gap-3">
                    <button class="bg-emerald-800/50 p-2.5 rounded-full backdrop-blur-sm relative">
                        ...
                        <div class="absolute top-2 right-2.5 w-2 h-2 bg-amber-400 rounded-full border-2 border-emerald-900">
                        </div>
                    </button>
                </div>
            </div>
        ...
        <div class="relative z-20 px-4 sm:px-6 lg:px-8 -mt-20 max-w-5xl mx-auto space-y-6">
            ...
            <div class="bg-amber-50 border border-amber-100 rounded-xl p-3 flex items-center justify-between shadow-sm">
            ...
            <div>
                ...
                <div class="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-5 gap-y-6 gap-x-2">
                    ...
                    <a href="#" class="flex flex-col items-center group">
                        ...
                        <span class="text-[10px] sm:text-xs text-center mt-2 font-medium text-slate-600 leading-tight">Dam
                            &<br />Sedekah</span>
                    </a>
            ...
            <div>
                ...
                <div class="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-5 gap-y-6 gap-x-2">
                    ...
                    <a href="#" class="flex flex-col items-center group">
                        ...
                        <span class="text-[10px] sm:text-xs text-center mt-2 font-medium text-slate-600 leading-tight">Top
                            Up<br />E-Wallet</span>
                    </a>
                </div>
            </div>
            ...
            <div class="mt-8">
                <div class="flex gap-4 overflow-x-auto pb-4 no-scrollbar snap-x">
                    ...
                    <div
                        ...
                        <svg class="absolute -bottom-4 -right-4 w-24 h-24 text-emerald-500 opacity-50" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path
                    ...
                    <div
                        ...
                        <svg class="absolute -bottom-2 -right-2 w-20 h-20 text-amber-400 opacity-50" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
